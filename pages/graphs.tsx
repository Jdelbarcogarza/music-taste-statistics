...
const Graphs: NextPage = () => {
  ...
  async function getTopTracks() {
    ...
    const req2 = await axios.get("https://api.spotify.com/v1/audio-features", {
      headers: {
        Authorization: `Bearer ${data.session?.provider_token}`,
      },
      params: {
    ...
    console.log(req2.data.audio_features)
  ...
  return (
    <div style={{
      ...
      <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={getTopTracks}>
        Mostrar Gráficas
      </button>
    </div>
  )
